...
class InsightEngine:
    ...
    def __init__(self, api_key: str, model: str, db_path: str, hitl: bool = False, show_output: bool = False):
        ...
        self._grafo = Graph(api_key=api_key, model=self._model, hitl=self._hitl_ativado)
